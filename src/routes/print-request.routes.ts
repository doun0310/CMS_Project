...
import {
  ...
  reprintRequest,
  analyzePIIHandler,
  analyzeLayoutHandler,
  subscribePrintEvents
...
router.get("/events", subscribePrintEvents);
router.get("/", asyncHandler(listPrintRequests));
router.post("/analyze-pii", asyncHandler(analyzePIIHandler));
router.post("/analyze-layout", asyncHandler(analyzeLayoutHandler));
