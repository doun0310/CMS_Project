...
### 👨‍💼 14. Manager Team Resource & Capacity Matrix (중간관리자 전용 팀 리소스 & 역량 매트릭스)
...
### 🕸️ 20. Interactive Issue Dependency Matrix & Downstream Task Canvas (이슈 종속성 & 블로커 매트릭스)
...
### 🛡️ 22. AI Multi-Factor Sprint Risk Matrix & Automated Mitigation Recommender (스프린트 리스크 다요인 분석 & AI 조치 완화기)
